...
An example from my own stack: [Chelicera](../development/projects/chelicera.md) collects emails, [Stinger](../development/projects/stinger.md) parses and checks them, and Mailrain sends — tied together with a script, or run manually as separate tools when that's more useful.
